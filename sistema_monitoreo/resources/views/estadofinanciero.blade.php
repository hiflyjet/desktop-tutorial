                    ...
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            ...
                            <div class="container" style="border: #555 6px solid;height: 530px;border-radius: 10px;padding-left: 15px;">
                                  <div class="row">
                                      <div class="col-md-7" >
                                          <div style="margin:10px;height: 350px;width:90%;background: url(img_okt/tank.jpg);background-size: cover;background-position: 0px -30px;border:#666 3px solid;border-radius:10px; "></div>
                                      </div>
                                      <div class="col-md-5" >

                                        <p style=" font-weight:bold;font-size: 20px; text-align: left;color:#000; margin-top:30px;">
                                            Adeudo total proveedores:<br>
                                            5,458,400.00<br><br>
                                            Adeudo clientes:<br>
                                            10,580,500.00
                                        </p>
