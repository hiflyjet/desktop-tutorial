                    ...
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <select class="form-control">
                                <OPTION>SERVICIO CASCADA</OPTION>
                                <OPTION>SERVICIO COLIBRÍ</OPTION>
                                <OPTION>SERVI REMDU</OPTION>
                                <OPTION>OKTAN SMART</OPTION>
                                <OPTION>OKTAN MAYORAZGO</OPTION>
                                <OPTION>OKTAN CASTILLOTLA</OPTION>
                                <OPTION>OKTAN SAN ISIDRO</OPTION>
                                <OPTION>OKTAN PERIFERICO HEROES</OPTION>
                                <OPTION>SERVICIO GAS_5</OPTION>
                                <OPTION>SAN FERNANDO</OPTION>
                                <OPTION>OKTAN VANGUARD</OPTION>
                                <OPTION>SERVIOKTAN</OPTION>
                                <OPTION>G.G. ÉXITO</OPTION>
                                <OPTION>OKTAN MAGNUS</OPTION>
                                <OPTION>SERVI OK</OPTION>
                                <OPTION>SERVI K - FIVER</OPTION>
                                <OPTION>SERVI CLEAN</OPTION>
                                <OPTION>EKO</OPTION>
                                <OPTION>SERVI PENINSULAR</OPTION>
                                <OPTION>SERVITALLERES</OPTION>
                            </select><BR>
                            <div class="container" style="border: #555 6px solid;height: 480px;border-radius: 10px;padding-left: 15px;">
                                  <div class="row">
                                      <div class="col-md-7" >
                                          <div style="margin:10px;height: 300px;width:90%;background: url(img/fotografias/Oktan.jpg);background-size: cover;background-position: 0px -70px;border:#666 3px solid;border-radius:10px; "></div>
                                      </div>
                                      <div class="col-md-5" ><img src="img/chart.JPG" style="height: 300px;"></div>
                                  </div>
                                    <div class="row">
